...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'rwhewison';//this will be your WCC username
      $dbUsr = 'rwhewison';//this will be your WCC username
      $dbPass = 'wra6hDqDrJgW';//this will be the password found in the video.
