...
//defines the text variables that will be injected into the HTML
$title = "My Web Page";
$header1 = "My Web Page";
$name = "Robert Hewison";
...
//the amount of paragraphs you want to add to the webpage (default is 3)
$paragraphAmount = 3;

// Function to repeat paragraph a certain number of times inside a for loop
function repeatParagraphs($num, $string) {
    $paragraphs = "";
    for ($i = 0; $i < $num; $i++) {
      $paragraphs .= $string;
      $paragraphs .= "<br>" . "<br>";
...
// Call function and store results in $paragraphs variable
$paragraphs = repeatParagraphs($paragraphAmount, $paragraph);
